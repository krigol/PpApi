...
namespace BeerPal.Controllers
{
    public class SingleController : Controller
    {
        ...
        public SingleController(IPayPalApiHelperService payPalApiHelperService)
        {
        ...
        public ActionResult Index(IndexVm model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    experience_profile_id = "XP-DZHF-DJV2-984C-E2GL", // Created in the WebExperienceProfilesController. This one is for DigitalGoods.
                    intent = "sale",
                    payer = new Payer
                    {
